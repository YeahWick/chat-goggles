...
#This doesn't work. Maybe put something similar into a modal __init__
def warm_model():
...
image = Image.debian_slim().pip_install("transformers", "torch", "einops",
                                        "huggingface_hub").run_function(download_model).pip_install("accelerate").run_function(warm_model)
